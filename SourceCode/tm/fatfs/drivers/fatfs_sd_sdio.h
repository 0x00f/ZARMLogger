...
#define SDIO_INIT_CLK_DIV             ((uint8_t)0x76) /* Prescaler: f = 48MHz / (SDIO_INIT_CLK_DIV + 2) = 393.442kHz */

/**
 * @brief  SDIO Data Transfer Frequency (25MHz max)
 */
#define SDIO_TRANSFER_CLK_DIV         ((uint8_t)0x0)  /* Prescaler: f = 48MHz / (SDIO_INIT_CLK_DIV + 2) = 24MHz */
